...
protected void kosong(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT STATUS STOCK");
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        // TODO add your handling code here:
try{
            String sql = "update status set SIF=?,Description=?,qty_status=?,pemilik=?,status=? where faktur=?";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1,txPartNumber.getText());
            stat.setString(2,txDescription.getText());
            stat.setString(3,cbQty.getSelectedItem().toString());
            stat.setString(4,cbPemilik.getSelectedItem().toString());
            stat.setString(5,cbStatus.getSelectedItem().toString());
            stat.setString(6,txFaktur.getText());
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null, "Status Sparepart Berahsil Diubah");
            kosong();
            txFaktur.requestFocus();
        }catch (SQLException ex){
            JOptionPane.showMessageDialog(null, "Status Sparepart Gagal Diubah "+ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
