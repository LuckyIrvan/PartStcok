 ...
 * @author lucky
 */
public class StockSparePart extends javax.swing.JFrame {
...
protected void Tampil_Tanggal() {
    ...
    private void bCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCariActionPerformed
        ...
        String sql = "select * from stockmast where SIF like '%"+txCari.getText()+"%' or Description like '%"+txCari.getText()+"%'";
