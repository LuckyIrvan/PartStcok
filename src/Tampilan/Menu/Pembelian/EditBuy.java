 ...
 * @author lucky
 */
public class EditBuy extends javax.swing.JFrame {
...
protected void date(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT PEMBELIAN SPAREPART");
...
try{
            String sql = "update beli set id_vendor=?,SIF=?,Description=?,qty_beli=?,status=?,tanggal=? where faktur=?";
            ...
            stat.setString(6,txUpdate.getText());
            stat.setString(7,txFaktur.getText());
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null, "Pembelian Sparepart Berahsil Diubah");
            kosong();
            txPartNumber.requestFocus();
        }catch (SQLException ex){
            JOptionPane.showMessageDialog(null, "Pembelian Sparepart  Gagal Diubah "+ex);
        }
    ...
    private void txIdVendorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txIdVendorKeyReleased
        ...
        if (kode == evt.VK_ENTER || kode == evt.VK_TAB){
         try {
        String id = txIdVendor.getText();
            String sql = "SELECT nama FROM vendor WHERE id = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBuy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
